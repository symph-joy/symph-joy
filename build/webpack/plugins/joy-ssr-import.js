...
export default class JoySsrImportPlugin {
  apply (compiler) {
    compiler.hooks.compilation.tap('JoySSRImport', (compilation) => {
      compilation.mainTemplate.hooks.requireEnsure.tap('JoySSRImport', (code, chunk) => {
        ...
        let relativePathToBaseDirNormalized = relativePathToBaseDir.replace(/\\/g, '/')
