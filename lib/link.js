...
import Router, { _rewriteUrlForSymphonyExport } from './router'
...
export default class Link extends Component {
  ...
  render () {
    ...
    if (
      props.href &&
      typeof __SYMPHONY_DATA__ !== 'undefined' &&
      __SYMPHONY_DATA__.symphonyExport
    ) {
      props.href = _rewriteUrlForSymphonyExport(props.href)
    }
