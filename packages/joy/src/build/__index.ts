...
// @ts-ignore todo 去掉 telemetry ci相关的
...
export type {
  IWebpackEmitModule,
  TWebpackEmitModuleManifest,
} from "./webpack/plugins/emit-src-plugin/emit-src-plugin";
        ...
        ssgPages.forEach((page) => {
          if (isDynamicRoute(page)) {
            ...
            if (ssgStaticFallbackPages.has(page)) {
              ...
              // fallback render.
              defaultMap[page] = { page, query: { __joyFallback: true } };
            } else {
