...
import { IAutoCssModulesOpts } from "./joy-auto-css-modules";

function transformWithPlugin(code: string, opts: IAutoCssModulesOpts) {
  const filename = "file.js";
  return transform(code, {
    filename,
    plugins: [[require.resolve("./joy-auto-css-modules"), opts]],
  })!.code;
}
describe("joy-auto-css-modules", () => {
  test("css modules", () => {
