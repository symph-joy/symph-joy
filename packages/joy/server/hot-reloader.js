...
import { addCorsSupport } from "./utils";
import {
...
const matchJoyPageBundleRequest = route(
  "/_joy/static/:buildId/pages/:path*.js(.map)?"
);
...
export default class HotReloader {
  ...
  async prepareBuildTools(multiCompiler) {
    ...
    // We don’t watch .git .joy/ and node_modules for changes
    const ignored = [/\.git/, /\.joy\//, /node_modules/];
