...
export default async function getBaseWebpackConfig(
  ...
  const defaultLoaders = {
    ...
    hotSelfAccept: {
      ...
      options: {
        include: [path.join(dir, "pages"), path.join(dir, "src")],
  ...
  const errorCompFilePath = getErrorCompFilePath({
    dir,
    joyPagesDir: DEFAULT_PAGES_DIR,
  });
  const documentCompFilePath = getDocumentCompFilePath({
    dir,
    joyPagesDir: DEFAULT_PAGES_DIR,
  });
  ...
  const webpackMode: "development" | "production" | "none" = dev
    ? "development"
    : "production";
  ...
  let webpackConfig: webpack.Configuration = {
    ...
    plugins: [
      ...
      !isServer &&
        new ClientGlobalComponentPlugin({
          sourceFilePath: appEntryFilePath,
          globalName: "__JOY_APP_MAIN",
        }),
      !isServer &&
        new ClientGlobalComponentPlugin({
          sourceFilePath: errorCompFilePath,
          globalName: "__JOY_ERROR",
        }),
