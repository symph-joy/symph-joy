...
export class CoreContext implements ICoreContext {
  ...
  public getProviderDefinition<TInput = any>(typeOrToken: TypeOrTokenType<TInput>): InstanceWrapper<TInput> | undefined {
  ...
  public syncTryGetProvider<TInput = any>(typeOrToken: TypeOrTokenType<TInput>, options?: { strict?: boolean }): TInput | undefined {
  ...
  public syncGetProvider<TInput = any>(typeOrToken: TypeOrTokenType<TInput>, options?: { strict?: boolean }): TInput {
  ...
  protected async initContext(): Promise<InstanceWrapper[]> {
    return [];
  }
  ...
  public registerModule(module: EntryType | EntryType[]): InstanceWrapper[] {
  ...
  public async loadModule(module: EntryType | EntryType[]): Promise<InstanceWrapper[]> {
  ...
  protected async initProviders(instanceWrappers: InstanceWrapper[]): Promise<void> {
