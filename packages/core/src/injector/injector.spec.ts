...
describe("injector", () => {
  ...
  describe("loadProvider", () => {
    describe("load class provider", () => {
      ...
      let singProviderWrapper: InstanceWrapper<SingProvider>, transProviderWrapper: InstanceWrapper<TransProvider>, mainTestWrapper: InstanceWrapper<MainTest>, container: CoreContainer;
