...
import { ApplicationConfig } from "../application-config";
import { Injector, InstanceWrapper, Logger, TProviderName, Type } from "@symph/core";
...
export class RoutesResolver implements Resolver {
  ...
  public resolve<T extends HttpServer>(applicationRef: T, basePath: string, wrappers?: InstanceWrapper[]) {
    const ctsWrappers = [] as InstanceWrapper[];
    if (wrappers) {
  ...
  public registerRouters(
    routes: InstanceWrapper<Controller>[],
    // moduleName: string,
    basePath: string,
