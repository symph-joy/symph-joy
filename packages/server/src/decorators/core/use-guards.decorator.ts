...
import { isFunction } from "@symph/core/dist/utils/shared.utils";
import { validateEach } from "@symph/core/dist/utils/validate-each.util";
...
export function UseGuards(
  ...
  return (
    ...
    validateEach(target, guards, isGuardValid as any, "@UseGuards", "guard");
