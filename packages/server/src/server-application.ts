 ...
 * @publicApi
 */
import { Abstract, ContextId, CoreContext, EntryType, InstanceWrapper, Logger, Type, ValueProvider } from "@symph/core";
...
export class ServerApplication extends CoreContext implements INestApplication {
  ...
  public registerHttpServer() {
    this.httpAdapter = this.syncGetProvider(AbstractHttpAdapter);
  ...
  public async registerRouter(wrappers: InstanceWrapper[]) {
