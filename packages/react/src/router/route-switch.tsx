...
import { Route, Routes, RoutesProps, useLocation, createRoutesFromChildren } from "react-router-dom";
import { useJoyContext } from "../hooks";
import { IReactRoute } from "../interfaces";

interface RouterContainerType extends RoutesProps {
  routes: IReactRoute[];
  extraProps?: any;
}

// export function Routes({ children, location }: RoutesProps): React.ReactElement | null {
//   const routesObjs = createRoutesFromChildren(children);
//   if (!routesObjs) {
//     return null;
//   }
//   for (const routeObj of routesObjs) {
//     if (routeObj.providerName) {
//     }
//   }
//   return  null
// }
