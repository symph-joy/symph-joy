...
import { getSortedRoutes, RoutePathNode } from "./route-sorter";
...
describe("route-sorter", () => {
  ...
  describe("sort nested route", () => {
    test("sort basic nested", () => {
      ...
      [
        ...
        root.insertRoute(value);
      });
      const sorted = root.smooth();
      console.log(sorted);
    ...
    test("sort nested dynamic routes.", () => {
      const root = new RoutePathNode();
      [
        {
          path: "/blog/posts",
